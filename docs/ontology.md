# 1.6 연구 도메인 개념 모델 (Domain Concept Model)

보고서 ① 프로젝트 개요 — 1.6절 "연구 도메인 개념 모델" 참고용

> ※ 본 연구에서 '개념 모델'은 OWL/RDF 기반 formal ontology가 아닌,
> 도메인 개념과 관계를 정의한 분석 프레임워크(analytical framework)로서 활용한다.
> Formal ontology 확장은 향후 연구로 남긴다.

---

## [표 2] 개념 모델 클래스 및 관계 정의
